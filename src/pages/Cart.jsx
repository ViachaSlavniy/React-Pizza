...
import { clearCartAC, removePizzaAC, addPizzaAC, removeCartItemAC } from '../redux/actions/cart';
...
function Cart() {
    ...
    const addPizza = (id, price) => {
            dispatch(addPizzaAC(id, price))
    }

    const removePizza = (id, price) => {
        dispatch(removePizzaAC(id, price))
    }
        ...
        <div className="container container--cart">
            ...
            :<div className="cart">
                ...
                <div className="content__items">
                    {addedPizzasGroup.map(obj => <CartItem key={obj.id} 
                    {...obj} 
